...
export default function Terms() {
    return (
        <div className="page-container-text">
            ...
            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named GoPlay! - Montana Repertory Theatre</p>
            ...
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Montana Repertory Theatre, 32 Campus Drive.</p>
            ...
            <p><strong>Website</strong> refers to Montana Repertory Theatre, accessible from <a href="goplay.montanarep.com">goplay.montanarep.com</a></p>
            ...
            <ul>
            <li>By email: goplay@montanarep.com</li>
            </ul>
        </div>
    )
}
