...
export default function PrivacyPolicy() {
    return (
        <div className="page-container-text">
            ...
            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Go Play! - Montana Repertory Theatre</p>
